"""Cloud Run Worker macro — generates Cloud Run Worker Pool manifests and deploy targets."""
...
def cloudrun_worker(
        ...
        timeout_seconds = 300,
        **kwargs):
    """Generates Cloud Run Worker Pool manifests and deploy targets.
    ...
    Args:
        ...
        worker_name: Cloud Run worker pool name.
        region: GCP region.
